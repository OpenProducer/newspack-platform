...
<div class="wp-block-group has-base-background-color has-background" style="margin-bottom:var(--wp--preset--spacing--80);padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:0;padding-left:var(--wp--preset--spacing--30)">
	...
	<!-- wp:columns {"verticalAlignment":"center","lock":{"move":false,"remove":true},"metadata":{"name":"<?php esc_html_e( 'Menu', 'newspack-block-theme' ); ?>"},"align":"wide","className":"is-style-first-col-to-second"} -->
	<div class="wp-block-columns alignwide are-vertically-aligned-center is-style-first-col-to-second">
