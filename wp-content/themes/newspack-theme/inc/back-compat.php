...
function newspack_upgrade_notice() {
	...
	$message = sprintf( esc_html__( 'Newspack Theme requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'newspack-theme' ), esc_html( $GLOBALS['wp_version'] ) );
...
function newspack_customize() {
	wp_die(
		sprintf(
			/* translators: %s: WordPress version used by current site. */
			esc_html__( 'Newspack Theme requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'newspack-theme' ),
...
function newspack_preview() {
	if ( isset( $_GET['preview'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
		/* translators: %s: WordPress version used by current site. */
		wp_die( sprintf( esc_html__( 'Newspack Theme requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'newspack-theme' ), esc_html( $GLOBALS['wp_version'] ) ) );
	}
}
