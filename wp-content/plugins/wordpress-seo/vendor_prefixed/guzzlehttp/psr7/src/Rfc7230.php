...
final class Rfc7230
{
    ...
    private static function isValidHostHeaderHost(string $host) : bool
    {
        ...
        if (\strpos($host, '[') !== \false || \strpos($host, ']') !== \false) {
            ...
            return \filter_var($address, \FILTER_VALIDATE_IP, \FILTER_FLAG_IPV6) !== \false || \preg_match('/^v[0-9a-f]+\\.[' . \YoastSEO_Vendor\GuzzleHttp\Psr7\Rfc3986::CHAR_UNRESERVED . \YoastSEO_Vendor\GuzzleHttp\Psr7\Rfc3986::CHAR_SUB_DELIMS . ':]+$/iD', $address) === 1;
        }
