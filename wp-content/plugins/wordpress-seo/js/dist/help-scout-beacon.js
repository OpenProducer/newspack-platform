...
`;function l(e){const t=document.createElement("div");t.setAttribute("id","yoast-helpscout-beacon"),(0,n.createRoot)(t).render(e),document.body.appendChild(t)}function s(){return!!document.getElementById("sidebar")}function c(e,n=""){!function(e,t){let n=e.Beacon||function(){};function o(){const e=t.getElementsByTagName("script")[0],n=t.createElement("script");n.type="text/javascript",n.async=!0,n.src="https://beacon-v2.helpscout.net",e.parentNode.insertBefore(n,e)}if(e.Beacon=n=function(t,n,o){e.Beacon.readyQueue.push({method:t,options:n,data:o})},n.readyQueue=[],"complete"===t.readyState)return o();e.attachEvent?e.attachEvent("onload",o):e.addEventListener("load",o,!1)}(window,document,window.Beacon),window.Beacon("init",e),function(e){""!==e&&(void 0!==(e=JSON.parse(e)).name&&void 0!==e.email&&(window.Beacon("prefill",{name:e.name,email:e.email}),delete e.name,delete e.email),window.Beacon("session-data",e))}(n),"1"===window.wpseoAdminGlobalL10n.isRtl&&window.Beacon("config",{display:{position:"left"}}),s()&&l((0,t.createElement)(r,{isRtl:window.wpseoAdminGlobalL10n.isRtl}))}window.wpseoHelpScoutBeacon=c,window.wpseoHelpScoutBeaconConsent=function(e,i=null){const d=a().div`
	...
	`;l((0,t.createElement)((()=>{const[a,l]=(0,n.useState)(!0),p=s();return(0,t.createElement)(n.Fragment,null,p&&(0,t.createElement)(r,{isRtl:window.wpseoAdminGlobalL10n.isRtl}),a&&(0,t.createElement)(d,{className:p?"BeaconFabButtonFrame":"",isRtl:window.wpseoAdminGlobalL10n.isRtl},(0,t.createElement)(m,{type:"button",onClick:function(){const t=(0,o.__)("When you click OK we will open our HelpScout beacon where you can find answers to your questions. This beacon will load our support data and also potentially set cookies.","wordpress-seo");window.confirm(t)&&(c(e,i),window.Beacon("open"),window.setTimeout((()=>{l(!1)}),1e3))}},(0,t.createElement)(w,null))))}),null))}})();