...
// translators: %s: file name.
(0,o.__)("%s: This file is empty."),e.name),file:e}):(g.push(e),d.push({url:(0,c.createBlobURL)(e)}),l(d)):a({code:"MIME_TYPE_NOT_SUPPORTED",message:(0,o.sprintf)(
// translators: %s: file name.
...
// translators: %s: file name
(0,o.__)("Error while uploading file %s to the media library."),i.name),a({code:"GENERAL",message:s,file:i})}}}function w(e,t){const i=new window.FormData;return i.append("file",e,e.name||e.type.replace("/",".")),t&&Object.entries(t).forEach((([e,t])=>i.append(e,t))),h()({path:"/wp/v2/media",body:i,method:"POST"})}(window.wp=window.wp||{}).mediaUtils=t})();
