  ...
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)(
    Stack,
    {
      ...
      children: [
        ...
        !!actions?.length && /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("div", { className: "dataviews-view-grid__media-actions", children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ItemActions, { item, actions, isCompact: true }) }),
...
function Header({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime100.jsxs)(import_components47.__experimentalVStack, { className: "admin-ui-page__header", as: "header", children: [
    /* @__PURE__ */ (0, import_jsx_runtime100.jsxs)(import_components47.__experimentalHStack, { justify: "space-between", spacing: 2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime100.jsxs)(import_components47.__experimentalHStack, { spacing: 2, justify: "left", children: [
        ...
        title && /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(import_components47.__experimentalHeading, { as: "h2", level: 3, weight: 500, truncate: true, children: title }),
        breadcrumbs,
        badges
      ] }),
...
function CreateTemplatePartModalContents({
  ...
  const [title, setTitle] = (0, import_element58.useState)(defaultTitle);
  const [area, setArea] = (0, import_element58.useState)(defaultArea);
  const [isSubmitting, setIsSubmitting] = (0, import_element58.useState)(false);
...
if (typeof document !== "undefined" && true && !document.head.querySelector("style[data-wp-hash='ae8ae60144']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "ae8ae60144");
...
function TemplatePartList() {
  ...
  const [showTemplatePartModal, setShowTemplatePartModal] = (0, import_element59.useState)(false);
  const defaultView = DEFAULT_VIEW;
  const activeViewOverrides = (0, import_element59.useMemo)(
  ...
  const postTypeQuery = (0, import_element59.useMemo)(() => viewToQuery(view), [view]);
  const {
    records: posts,
    totalItems,
    totalPages,
  ...
  const cleanupDeletedPostIdsFromUrl = (0, import_element59.useCallback)(
    (deletedItems) => {
  ...
  const handleTabChange = (0, import_element59.useCallback)(
    (areaSlug) => {
      navigate({
