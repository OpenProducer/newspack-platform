...
if (typeof document !== "undefined" && !document.head.querySelector("style[data-wp-hash='3d47e56827']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "3d47e56827");
...
if (typeof document !== "undefined" && !document.head.querySelector("style[data-wp-hash='f79b316663']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "f79b316663");
...
if (typeof document !== "undefined" && !document.head.querySelector("style[data-wp-hash='24b25e7f9f']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "24b25e7f9f");
