...
;// CONCATENATED MODULE: external ["wp","sync"]
...
function getSyncProvider() {
  if (!syncProvider) {
    syncProvider = (0,external_wp_sync_namespaceObject.createSyncProvider)(external_wp_sync_namespaceObject.connectIndexDb, external_wp_sync_namespaceObject.connectWebRTC);
  }
  return syncProvider;
}
 ...
 */
const getReferenceByDistinctEdits = rememo(
