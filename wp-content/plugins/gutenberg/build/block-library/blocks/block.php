...
if ( $gutenberg_experiments && array_key_exists( 'gutenberg-pattern-partial-syncing', $gutenberg_experiments ) ) {
	 ...
	 * @return array $args
	 */
	function gutenberg_gutenberg_register_block_core_block_args( $args, $block_name ) {
	...
	add_filter( 'register_block_type_args', 'gutenberg_gutenberg_register_block_core_block_args', 10, 2 );
}
