 ...
 * @param int $revision_id The revision ID.
 */
function gutenberg_keep_footnotes_revision_id( $revision_id ) {
	global $wp_temporary_footnote_revision_id;
	$wp_temporary_footnote_revision_id = $revision_id;
}
add_action( '_wp_put_post_revision', 'gutenberg_keep_footnotes_revision_id' );
 ...
 */
function gutenberg_add_footnotes_revisions_to_post_meta( $post ) {
	global $wp_temporary_footnote_revision_id;
...
add_action( 'rest_after_insert_post', 'gutenberg_add_footnotes_revisions_to_post_meta' );
add_action( 'rest_after_insert_page', 'gutenberg_add_footnotes_revisions_to_post_meta' );
 ...
 * @param int $revision_id The revision ID.
 */
function gutenberg_restore_footnotes_from_revision( $post_id, $revision_id ) {
...
add_action( 'wp_restore_post_revision', 'gutenberg_restore_footnotes_from_revision', 10, 2 );
 ...
 */
function gutenberg__wp_rest_api_autosave_meta( $autosave ) {
...
add_action( 'wp_creating_autosave', 'gutenberg__wp_rest_api_autosave_meta' );
...
add_action( '_wp_put_post_revision', 'gutenberg__wp_rest_api_autosave_meta' );
 ...
 */
function gutenberg__wp_rest_api_force_autosave_difference( $prepared_post, $request ) {
...
add_filter( 'rest_pre_insert_post', 'gutenberg__wp_rest_api_force_autosave_difference', 10, 2 );
