 ...
 */
function gutenberg_render_block_core_avatar( $attributes, $content, $block ) {
	$size               = isset( $attributes['size'] ) ? $attributes['size'] : 96;
	$wrapper_attributes = get_block_wrapper_attributes();
	$border_attributes  = gutenberg_get_block_core_avatar_border_attributes( $attributes );
 ...
 */
function gutenberg_get_block_core_avatar_border_attributes( $attributes ) {
	$border_styles = array();
 ...
 */
function gutenberg_register_block_core_avatar() {
	register_block_type_from_metadata(
		__DIR__ . '/avatar',
		array(
			'render_callback' => 'gutenberg_render_block_core_avatar',
		)
	);
}
add_action( 'init', 'gutenberg_register_block_core_avatar', 20 );
