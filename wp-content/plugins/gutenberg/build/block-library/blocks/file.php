...
if ( gutenberg_should_block_use_interactivity_api( 'core/file' ) ) {
	 ...
	 */
	function gutenberg_gutenberg_block_core_file_update_interactive_view_script( $metadata ) {
	...
	add_filter( 'block_type_metadata', 'gutenberg_gutenberg_block_core_file_update_interactive_view_script', 10, 1 );
}
