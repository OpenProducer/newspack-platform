 ...
 */
function gutenberg_block_core_query_ensure_interactivity_dependency() {
	global $wp_scripts;
	if (
...
add_action( 'wp_print_scripts', 'gutenberg_block_core_query_ensure_interactivity_dependency' );
...
add_filter( 'render_block_data', 'gutenberg_block_core_query_disable_enhanced_pagination', 10, 1 );
