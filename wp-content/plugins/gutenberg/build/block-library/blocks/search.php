 ...
 */
function gutenberg_render_block_core_search( $attributes, $content, $block ) {
 ...
 */
function gutenberg_block_core_search_ensure_interactivity_dependency() {
	global $wp_scripts;
	if (
...
add_action( 'wp_print_scripts', 'gutenberg_block_core_search_ensure_interactivity_dependency' );
