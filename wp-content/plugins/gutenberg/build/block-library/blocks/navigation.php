...
if ( function_exists( 'set_ignored_hooked_blocks_metadata' ) && ! has_filter( 'rest_pre_insert_wp_navigation', $rest_insert_wp_navigation_core_callback ) ) {
	add_filter( 'rest_pre_insert_wp_navigation', 'gutenberg_block_core_navigation_update_ignore_hooked_blocks_meta', 10 );
}

// Previous versions of Gutenberg and WordPress 6.5 Betas were attaching the gutenberg_block_core_navigation_update_ignore_hooked_blocks_meta
