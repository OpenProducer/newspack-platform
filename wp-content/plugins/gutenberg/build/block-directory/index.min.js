...
(0,v.__)("Your site doesn’t include support for the %s block. You can try installing the block, convert it to a Custom HTML block, or remove it entirely."),e.title||l),b.push((0,le.jsx)(J.Button,{onClick:()=>{n(t.clientId,(0,i.createBlock)("core/html",{content:o}))},variant:"tertiary",children:(0,v.__)("Keep as HTML")},"convert"))),(0,le.jsxs)("div",{...(0,p.useBlockProps)(),children:[(0,le.jsx)(p.Warning,{actions:b,children:u}),(0,le.jsx)(c.RawHTML,{children:o})]})};(0,n.registerPlugin)("block-directory",{render:()=>(0,le.jsxs)(le.Fragment,{children:[(0,le.jsx)(W,{}),(0,le.jsx)(Ee,{}),(0,le.jsx)(Le,{})]})}),(0,r.addFilter)("blocks.registerBlockType","block-directory/fallback",((e,t)=>{return"core/missing"!==t||(e.edit=(l=e.edit,e=>{const{originalName:t}=e.attributes,{block:o,hasPermission:s}=(0,a.useSelect)((e=>{const{getDownloadableBlocks:l}=e(G),o=l("block:"+t).filter((({name:e})=>t===e));return{hasPermission:e(Q.store).canUser("read","block-directory/search"),block:o.length&&o[0]}}),[t]);return s&&o?(0,le.jsx)(Oe,{...e,originalBlock:o}):(0,le.jsx)(l,{...e})})),e;var l})),(window.wp=window.wp||{}).blockDirectory=t})();
