...
// translators: %s: Name of the plural post type e.g: "Posts".
(0,fs.__)("Changes will be applied to all selected %s."),r?.name.toLowerCase())})]})}const Df=189;function Af(){const{postContent:e}=(0,c.useSelect)((e=>{const{getEditedPostAttribute:t,getCurrentPostType:s,getCurrentPostId:o}=e(Tc),{canUser:n}=e(d.store),{getEntityRecord:i}=e(d.store),r=n("read",{kind:"root",name:"site"})?i("root","site"):void 0,a=s();return{postContent:!(+o()===r?.page_for_posts)&&![T,B].includes(a)&&t("content")}}),[]),t=(0,fs._x)("words","Word count type. Do not translate!"),s=(0,u.useMemo)((()=>e?(0,Ih.count)(e,t):0),[e,t]);
/*
   * translators: If your word count is based on single characters (e.g. East Asian characters),
   * enter 'characters_excluding_spaces' or 'characters_including_spaces'. Otherwise, enter 'words'.
   * Do not translate into your own language.
   */if(!s)return null;const o=Math.round(s/Df),n=(0,fs.sprintf)(
