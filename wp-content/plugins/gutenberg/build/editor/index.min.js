...
i||(0,fs._x)("Document","noun, breadcrumb")}}),[]),w=(0,p.useViewportMatch)("medium"),C=b?(0,fs.__)("Document Overview"):(0,fs.__)("Block Library"),[P,j]=(0,u.useState)(!1),E=(0,u.useCallback)((e=>{"function"==typeof P&&P(e),j(!1)}),[P]);return(0,L.jsx)(cl,{isDistractionFree:y,className:pn("editor-editor-interface",e,{"is-entity-save-view-open":!!P,"is-distraction-free":y&&!x}),labels:{...yf,secondarySidebar:C},header:!x&&(0,L.jsx)($_,{forceIsDirty:o,setEntitiesSavedStatesCallback:j,customSaveButton:a,forceDisableBlockTools:d,title:m}),editorNotices:(0,L.jsx)(_d,{}),secondarySidebar:!x&&"visual"===_&&(f&&(0,L.jsx)(Z_,{})||b&&(0,L.jsx)(q_,{})),sidebar:!x&&!y&&(0,L.jsx)(ol.Slot,{scope:"core"}),content:(0,L.jsxs)(L.Fragment,{children:[!y&&!x&&(0,L.jsx)(_d,{}),(0,L.jsx)(Yg.Slot,{children:([e])=>e||(0,L.jsxs)(L.Fragment,{children:[!x&&"text"===_&&(0,L.jsx)(ef,{autoFocus:r}),!x&&!w&&"visual"===_&&(0,L.jsx)(h.BlockToolbar,{hideDragHandle:!0}),(x||"visual"===_)&&(0,L.jsx)(bf,{styles:t,contentRef:n,disableIframe:i,autoFocus:r,iframeProps:g}),s]})})]}),footer:!x&&!y&&w&&v&&"visual"===_&&(0,L.jsx)(h.BlockBreadcrumb,{rootLabelText:S}),actions:x?void 0:l||(0,L.jsx)(J_,{closeEntitiesSavedStates:E,isEntitiesSavedStatesOpen:P,setEntitiesSavedStatesCallback:j,forceIsDirtyPublishPanel:o})})}const{OverridesPanel:vf}=$(On.privateApis);function Sf(){return(0,c.useSelect)((e=>"wp_block"===e(Ac).getCurrentPostType()),[])?(0,L.jsx)(vf,{}):null}function wf(e){return"string"==typeof e.title?(0,Lo.decodeEntities)(e.title):e.title&&"rendered"in e.title?(0,Lo.decodeEntities)(e.title.rendered):e.title&&"raw"in e.title?(0,Lo.decodeEntities)(e.title.raw):""}const kf=({items:e,closeModal:t})=>{const[s]=e,o=wf(s),{showOnFront:n,currentHomePage:i,isSaving:r}=(0,c.useSelect)((e=>{const{getEntityRecord:t,isSavingEntityRecord:s}=e(d.store),o=t("root","site"),n=t("postType","page",o?.page_on_front);return{showOnFront:o?.show_on_front,currentHomePage:n,isSaving:s("root","site")}})),{saveEntityRecord:a}=(0,c.useDispatch)(d.store),{createSuccessNotice:l,createErrorNotice:u}=(0,c.useDispatch)(_s.store);let p="";"posts"===n?p=(0,fs.__)("This will replace the current homepage which is set to display latest posts."):i&&(p=(0,fs.sprintf)(
