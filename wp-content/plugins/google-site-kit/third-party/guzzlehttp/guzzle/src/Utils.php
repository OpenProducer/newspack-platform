...
use Google\Site_Kit_Dependencies\GuzzleHttp\Exception\InvalidArgumentException;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \Google\Site_Kit_Dependencies\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
    ...
    {
        return \sprintf('GuzzleHttp/%d', \Google\Site_Kit_Dependencies\GuzzleHttp\ClientInterface::MAJOR_VERSION);
    }
    /**
...
EOT
    ...
    {
        if (\strlen($host) === 0) {
            throw new \Google\Site_Kit_Dependencies\GuzzleHttp\Exception\InvalidArgumentException('Empty host provided');
        }
     ...
     * @internal
     */
    public static function idnUriConvert(\Google\Site_Kit_Dependencies\Psr\Http\Message\UriInterface $uri, int $options = 0) : \Google\Site_Kit_Dependencies\Psr\Http\Message\UriInterface
    {
        if ($uri->getHost()) {
            ...
            if ($asciiHost === \false) {
                ...
                throw new \Google\Site_Kit_Dependencies\GuzzleHttp\Exception\InvalidArgumentException($errorMessage);
            }
