...
class RetryMiddleware
{
     ...
     * @return mixed
     */
    private function onFulfilled(\Google\Site_Kit_Dependencies\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return callable
     */
    private function onRejected(\Google\Site_Kit_Dependencies\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return self
     */
    private function doRetry(\Google\Site_Kit_Dependencies\Psr\Http\Message\RequestInterface $request, array $options, \Google\Site_Kit_Dependencies\Psr\Http\Message\ResponseInterface $response = null)
    {
