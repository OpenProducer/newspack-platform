...
class HandlerStack
{
    ...
    {
        $stack = new self($handler ?: \Google\Site_Kit_Dependencies\GuzzleHttp\Utils::chooseHandler());
        $stack->push(\Google\Site_Kit_Dependencies\GuzzleHttp\Middleware::httpErrors(), 'http_errors');
        $stack->push(\Google\Site_Kit_Dependencies\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\Google\Site_Kit_Dependencies\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\Google\Site_Kit_Dependencies\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
