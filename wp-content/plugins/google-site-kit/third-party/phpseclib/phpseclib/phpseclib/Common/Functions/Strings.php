 ...
 */
namespace Google\Site_Kit_Dependencies\phpseclib3\Common\Functions;

use Google\Site_Kit_Dependencies\ParagonIE\ConstantTime\Base64;
use Google\Site_Kit_Dependencies\ParagonIE\ConstantTime\Base64UrlSafe;
use Google\Site_Kit_Dependencies\ParagonIE\ConstantTime\Hex;
...
abstract class Strings
{
    ...
    public static function unpackSSH2($format, &$data)
    {
        ...
        for ($i = 0; $i < \strlen($format); $i++) {
            ...
            switch ($format[$i]) {
                case 'i':
                    $result[] = new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger($temp, -256);
                    break;
                case 's':
                    $result[] = $temp;
                    break;
        ...
        for ($i = 0; $i < \strlen($format); $i++) {
            ...
            switch ($format[$i]) {
                ...
                case 's':
                    ...
                    break;
                case 'i':
                    if (!$element instanceof \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger && !$element instanceof \Google\Site_Kit_Dependencies\phpseclib3\Math\Common\FiniteField\Integer) {
    ...
    {
        return \function_exists('sodium_base642bin') ? \sodium_base642bin($data, \SODIUM_BASE64_VARIANT_ORIGINAL_NO_PADDING, '=') : \Google\Site_Kit_Dependencies\ParagonIE\ConstantTime\Base64::decode($data);
    }
    /**
    ...
    public static function base64url_decode($data)
    {
        ...
        return \function_exists('sodium_base642bin') ? \sodium_base642bin($data, \SODIUM_BASE64_VARIANT_URLSAFE_NO_PADDING, '=') : \Google\Site_Kit_Dependencies\ParagonIE\ConstantTime\Base64UrlSafe::decode($data);
    }
    /**
    ...
    {
        return \function_exists('sodium_bin2base64') ? \sodium_bin2base64($data, \SODIUM_BASE64_VARIANT_ORIGINAL) : \Google\Site_Kit_Dependencies\ParagonIE\ConstantTime\Base64::encode($data);
    }
    /**
    ...
    public static function base64url_encode($data)
    {
        ...
        return \function_exists('sodium_bin2base64') ? \sodium_bin2base64($data, \SODIUM_BASE64_VARIANT_URLSAFE_NO_PADDING) : \Google\Site_Kit_Dependencies\ParagonIE\ConstantTime\Base64UrlSafe::encode($data);
    }
    /**
    ...
    {
        return \function_exists('sodium_hex2bin') ? \sodium_hex2bin($data) : \Google\Site_Kit_Dependencies\ParagonIE\ConstantTime\Hex::decode($data);
    }
    /**
    ...
    {
        return \function_exists('sodium_bin2hex') ? \sodium_bin2hex($data) : \Google\Site_Kit_Dependencies\ParagonIE\ConstantTime\Hex::encode($data);
    }
}
