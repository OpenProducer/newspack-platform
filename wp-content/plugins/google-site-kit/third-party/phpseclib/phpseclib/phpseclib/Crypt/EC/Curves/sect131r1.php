...
class sect131r1 extends \Google\Site_Kit_Dependencies\phpseclib3\Crypt\EC\BaseCurves\Binary
{
    public function __construct()
    {
        ...
        $this->setOrder(new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger('0400000000000000023123953A9464B54D', 16));
    }
}
