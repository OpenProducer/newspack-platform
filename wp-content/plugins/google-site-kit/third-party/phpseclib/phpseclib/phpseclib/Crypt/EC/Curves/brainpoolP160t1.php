...
class brainpoolP160t1 extends \Google\Site_Kit_Dependencies\phpseclib3\Crypt\EC\BaseCurves\Prime
{
    public function __construct()
    {
        ...
        $this->setCoefficients(
            new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger('E95E4A5F737059DC60DFC7AD95B3D8139515620C', 16),
            // eg. -3
            new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger('7A556B6DAE535B7B51ED2C4D7DAA7A0B5C55F380', 16)
        );
        $this->setBasePoint(new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger('B199B13B9B34EFC1397E64BAEB05ACC265FF2378', 16), new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger('ADD6718B7C7C1961F0991B842443772152C9E0AD', 16));
