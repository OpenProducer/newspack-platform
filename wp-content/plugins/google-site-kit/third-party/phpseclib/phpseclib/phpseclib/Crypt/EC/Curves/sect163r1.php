...
class sect163r1 extends \Google\Site_Kit_Dependencies\phpseclib3\Crypt\EC\BaseCurves\Binary
{
    public function __construct()
    {
        ...
        $this->setOrder(new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger('03FFFFFFFFFFFFFFFFFFFF48AAB689C29CA710279B', 16));
    }
}
