...
use Google\Site_Kit_Dependencies\phpseclib3\Crypt\Common\Formats\Keys\OpenSSH as Progenitor;
...
abstract class OpenSSH extends \Google\Site_Kit_Dependencies\phpseclib3\Crypt\Common\Formats\Keys\OpenSSH
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if (isset($parsed['paddedKey'])) {
            ...
            $primes = $coefficients = [];
            list($modulus, $publicExponent, $privateExponent, $coefficients[2], $primes[1], $primes[2], $comment, ) = \Google\Site_Kit_Dependencies\phpseclib3\Common\Functions\Strings::unpackSSH2('i6s', $parsed['paddedKey']);
        ...
        list($publicExponent, $modulus) = \Google\Site_Kit_Dependencies\phpseclib3\Common\Functions\Strings::unpackSSH2('ii', $parsed['publicKey']);
    ...
    {
        $RSAPublicKey = \Google\Site_Kit_Dependencies\phpseclib3\Common\Functions\Strings::packSSH2('sii', 'ssh-rsa', $e, $n);
    ...
    public static function savePrivateKey(\Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger $n, \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger $e, \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger $d, array $primes, array $exponents, array $coefficients, $password = '', array $options = [])
    {
        ...
        $privateKey = \Google\Site_Kit_Dependencies\phpseclib3\Common\Functions\Strings::packSSH2('si6', 'ssh-rsa', $n, $e, $d, $coefficients[2], $primes[1], $primes[2]);
