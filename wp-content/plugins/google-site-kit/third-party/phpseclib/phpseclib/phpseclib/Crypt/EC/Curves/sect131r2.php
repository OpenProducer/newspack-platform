...
class sect131r2 extends \Google\Site_Kit_Dependencies\phpseclib3\Crypt\EC\BaseCurves\Binary
{
    public function __construct()
    {
        ...
        $this->setOrder(new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger('0400000000000000016954A233049BA98F', 16));
    }
}
