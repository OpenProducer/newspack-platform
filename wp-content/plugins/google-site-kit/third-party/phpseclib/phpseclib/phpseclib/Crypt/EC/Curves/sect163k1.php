...
class sect163k1 extends \Google\Site_Kit_Dependencies\phpseclib3\Crypt\EC\BaseCurves\Binary
{
    public function __construct()
    {
        ...
        $this->setOrder(new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger('04000000000000000000020108A2E0CC0D99F8A5EF', 16));
    }
}
