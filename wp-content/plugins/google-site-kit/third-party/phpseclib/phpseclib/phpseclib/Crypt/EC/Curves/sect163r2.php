...
class sect163r2 extends \Google\Site_Kit_Dependencies\phpseclib3\Crypt\EC\BaseCurves\Binary
{
    public function __construct()
    {
        ...
        $this->setOrder(new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger('040000000000000000000292FE77E70C12A4234C33', 16));
    }
}
