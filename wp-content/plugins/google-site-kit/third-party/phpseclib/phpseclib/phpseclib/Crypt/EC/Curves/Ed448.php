...
class Ed448 extends \Google\Site_Kit_Dependencies\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards
{
    ...
    public function __construct()
    {
        ...
        $this->setCoefficients(
            new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger(1),
            // -39081
            new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger('FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE' . 'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF6756', 16)
        );
    ...
    public function recoverX(\Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger $y, $sign)
    {
        ...
        $exp = $this->getModulo()->add(new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger(1));
    ...
    public function extractSecret($str)
    {
        ...
        $hash = new \Google\Site_Kit_Dependencies\phpseclib3\Crypt\Hash('shake256-912');
        $h = $hash->hash($str);
        $h = \substr($h, 0, 57);
    ...
    {
        return $this->extractSecret(\Google\Site_Kit_Dependencies\phpseclib3\Crypt\Random::string(57))['dA'];
    }
    /**
