...
use Google\Site_Kit_Dependencies\phpseclib3\Math\BinaryField\Integer;
 ...
 * @author  Jim Wigginton <terrafrost@php.net>
 */
class BinaryField extends \Google\Site_Kit_Dependencies\phpseclib3\Math\Common\FiniteField
{
    /**
     * Instance Counter
     *
    ...
    public function __construct(...$indices)
    {
        ...
        \Google\Site_Kit_Dependencies\phpseclib3\Math\BinaryField\Integer::setModulo($this->instanceID, $modulo);
        \Google\Site_Kit_Dependencies\phpseclib3\Math\BinaryField\Integer::setRecurringModuloFunction($this->instanceID, $reduce);
        $this->randomMax = new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger($modulo, 2);
    }
    /**
    ...
    {
        return new \Google\Site_Kit_Dependencies\phpseclib3\Math\BinaryField\Integer($this->instanceID, $num instanceof \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger ? $num->toBytes() : $num);
    }
    /**
    ...
    public function randomInteger()
    {
        ...
        return new \Google\Site_Kit_Dependencies\phpseclib3\Math\BinaryField\Integer($this->instanceID, \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger::randomRange($one, $this->randomMax)->toBytes());
    }
    /**
    ...
    {
        return \strlen(\Google\Site_Kit_Dependencies\phpseclib3\Math\BinaryField\Integer::getModulo($this->instanceID));
    }
    /**
    ...
    {
        return \strlen(\Google\Site_Kit_Dependencies\phpseclib3\Math\BinaryField\Integer::getModulo($this->instanceID)) << 3;
    }
    /**
    ...
    {
        $str = \Google\Site_Kit_Dependencies\phpseclib3\Common\Functions\Strings::bits2bin($x);
        $pad = \strlen($x) >> 3;
        if (\strlen($x) & 3) {
            $pad++;
        }
    ...
    public static function base256ToBase2($x)
    {
        ...
        return \Google\Site_Kit_Dependencies\phpseclib3\Common\Functions\Strings::bin2bits($x);
    }
}
