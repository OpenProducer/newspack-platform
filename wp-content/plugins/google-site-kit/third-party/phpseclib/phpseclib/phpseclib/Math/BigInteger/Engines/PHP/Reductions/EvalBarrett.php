 ...
 */
namespace Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger\Engines\PHP\Reductions;

use Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger\Engines\PHP;
use Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger\Engines\PHP\Base;
/**
 * PHP Dynamic Barrett Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class EvalBarrett extends \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger\Engines\PHP\Base
{
    /**
     ...
     * @return callable
     */
    protected static function generateCustomReduction(\Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $m, $class)
    {
