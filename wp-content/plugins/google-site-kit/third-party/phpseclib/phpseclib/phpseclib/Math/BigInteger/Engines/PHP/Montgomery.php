 ...
 */
namespace Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger\Engines\PHP;

use Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger\Engines\Engine;
use Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger\Engines\PHP;
use Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger\Engines\PHP\Reductions\PowerOfTwo;
/**
 * PHP Montgomery Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
