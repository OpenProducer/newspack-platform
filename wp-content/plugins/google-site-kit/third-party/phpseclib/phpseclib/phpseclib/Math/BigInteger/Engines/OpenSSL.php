...
use Google\Site_Kit_Dependencies\phpseclib3\Crypt\RSA\Formats\Keys\PKCS8;
...
abstract class OpenSSL
{
     ...
     * @return Engine
     */
    public static function powModHelper(\Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger\Engines\Engine $x, \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger\Engines\Engine $e, \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger\Engines\Engine $n)
    {
        ...
        $key = \Google\Site_Kit_Dependencies\phpseclib3\Crypt\RSA\Formats\Keys\PKCS8::savePublicKey(new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger($n), new \Google\Site_Kit_Dependencies\phpseclib3\Math\BigInteger($e));
