...
class NewsletterConfig extends \Google\Site_Kit_Dependencies\Google\Model
{
    /**
...
class_alias(NewsletterConfig::class, 'Google\Site_Kit_Dependencies\Google_Service_Webcontentpublisher_NewsletterConfig');
