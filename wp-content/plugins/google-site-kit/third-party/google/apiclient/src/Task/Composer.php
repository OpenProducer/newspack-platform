...
class Composer
{
    ...
    {
        $finder = (new \Google\Site_Kit_Dependencies\Symfony\Component\Finder\Finder())->directories()->depth('== 0');
    ...
    private static function getServicesToRemove($serviceDir, array $servicesToKeep)
    {
        ...
        return (new \Google\Site_Kit_Dependencies\Symfony\Component\Finder\Finder())->directories()->depth('== 0')->in($serviceDir)->exclude($servicesToKeep);
    }
}
