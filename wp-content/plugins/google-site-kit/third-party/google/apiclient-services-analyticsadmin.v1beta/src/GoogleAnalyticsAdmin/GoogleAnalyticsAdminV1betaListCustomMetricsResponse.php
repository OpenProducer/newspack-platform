...
class GoogleAnalyticsAdminV1betaListCustomMetricsResponse extends \Google\Site_Kit_Dependencies\Google\Collection
{
    ...
    protected $customMetricsType = \Google\Site_Kit_Dependencies\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1betaCustomMetric::class;
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1betaListCustomMetricsResponse::class, 'Google\\Site_Kit_Dependencies\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaListCustomMetricsResponse');
