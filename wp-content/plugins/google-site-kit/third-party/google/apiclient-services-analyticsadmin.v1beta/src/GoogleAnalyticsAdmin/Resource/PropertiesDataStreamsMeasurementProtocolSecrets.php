...
class_alias(PropertiesDataStreamsMeasurementProtocolSecrets::class, 'Google\Site_Kit_Dependencies\Google_Service_GoogleAnalyticsAdmin_Resource_PropertiesDataStreamsMeasurementProtocolSecrets');
