...
class GoogleAnalyticsAdminV1betaDataSharingSettings extends \Google\Site_Kit_Dependencies\Google\Model
{
    /**
...
class_alias(GoogleAnalyticsAdminV1betaDataSharingSettings::class, 'Google\Site_Kit_Dependencies\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaDataSharingSettings');
