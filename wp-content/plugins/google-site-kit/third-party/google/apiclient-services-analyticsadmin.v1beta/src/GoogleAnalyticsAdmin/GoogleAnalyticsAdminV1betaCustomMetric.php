...
class_alias(GoogleAnalyticsAdminV1betaCustomMetric::class, 'Google\Site_Kit_Dependencies\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaCustomMetric');
