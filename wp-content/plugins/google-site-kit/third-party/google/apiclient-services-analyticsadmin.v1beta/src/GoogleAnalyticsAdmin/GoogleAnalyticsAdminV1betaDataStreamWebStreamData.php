...
class GoogleAnalyticsAdminV1betaDataStreamWebStreamData extends \Google\Site_Kit_Dependencies\Google\Model
{
    /**
...
class_alias(GoogleAnalyticsAdminV1betaDataStreamWebStreamData::class, 'Google\Site_Kit_Dependencies\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaDataStreamWebStreamData');
