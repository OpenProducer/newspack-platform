...
use Google\Site_Kit_Dependencies\Google\Service\TagManager\BulkUpdateWorkspaceResponse;
...
use Google\Site_Kit_Dependencies\Google\Service\TagManager\ProposedChange;
