...
class EventData extends \Google\Site_Kit_Dependencies\Google\Model
{
    public $eventAction;
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\EventData::class, 'Google\\Site_Kit_Dependencies\\Google_Service_AnalyticsReporting_EventData');
