...
class GoalData extends \Google\Site_Kit_Dependencies\Google\Model
{
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\GoalData::class, 'Google\\Site_Kit_Dependencies\\Google_Service_AnalyticsReporting_GoalData');
