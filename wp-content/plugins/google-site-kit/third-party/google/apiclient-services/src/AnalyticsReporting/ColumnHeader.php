...
class ColumnHeader extends \Google\Site_Kit_Dependencies\Google\Collection
{
     ...
     * @param MetricHeader
     */
    public function setMetricHeader(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\MetricHeader $metricHeader)
    {
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\ColumnHeader::class, 'Google\\Site_Kit_Dependencies\\Google_Service_AnalyticsReporting_ColumnHeader');
