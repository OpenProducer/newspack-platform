...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\PageviewData::class, 'Google\\Site_Kit_Dependencies\\Google_Service_AnalyticsReporting_PageviewData');
