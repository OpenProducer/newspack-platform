...
class DynamicSegment extends \Google\Site_Kit_Dependencies\Google\Model
{
     ...
     */
    public function setSessionSegment(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\SegmentDefinition $sessionSegment)
    {
     ...
     * @param SegmentDefinition
     */
    public function setUserSegment(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\SegmentDefinition $userSegment)
    {
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\DynamicSegment::class, 'Google\\Site_Kit_Dependencies\\Google_Service_AnalyticsReporting_DynamicSegment');
