...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\PivotHeader::class, 'Google\\Site_Kit_Dependencies\\Google_Service_AnalyticsReporting_PivotHeader');
