...
class SearchUserActivityRequest extends \Google\Site_Kit_Dependencies\Google\Collection
{
     ...
     * @param User
     */
    public function setUser(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\User $user)
    {
        $this->user = $user;
    }
    /**
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\SearchUserActivityRequest::class, 'Google\\Site_Kit_Dependencies\\Google_Service_AnalyticsReporting_SearchUserActivityRequest');
