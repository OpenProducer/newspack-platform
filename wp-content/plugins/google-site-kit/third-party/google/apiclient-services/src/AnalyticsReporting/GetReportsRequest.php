...
class GetReportsRequest extends \Google\Site_Kit_Dependencies\Google\Collection
{
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\GetReportsRequest::class, 'Google\\Site_Kit_Dependencies\\Google_Service_AnalyticsReporting_GetReportsRequest');
