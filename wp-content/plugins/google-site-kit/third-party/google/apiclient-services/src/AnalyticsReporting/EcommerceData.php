...
class EcommerceData extends \Google\Site_Kit_Dependencies\Google\Collection
{
     ...
     */
    public function setTransaction(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\TransactionData $transaction)
    {
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\EcommerceData::class, 'Google\\Site_Kit_Dependencies\\Google_Service_AnalyticsReporting_EcommerceData');
