...
class ScreenviewData extends \Google\Site_Kit_Dependencies\Google\Model
{
    public $appName;
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\ScreenviewData::class, 'Google\\Site_Kit_Dependencies\\Google_Service_AnalyticsReporting_ScreenviewData');
