...
class GetReportsResponse extends \Google\Site_Kit_Dependencies\Google\Collection
{
     ...
     */
    public function setResourceQuotasRemaining(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\ResourceQuotasRemaining $resourceQuotasRemaining)
    {
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\AnalyticsReporting\GetReportsResponse::class, 'Google\\Site_Kit_Dependencies\\Google_Service_AnalyticsReporting_GetReportsResponse');
