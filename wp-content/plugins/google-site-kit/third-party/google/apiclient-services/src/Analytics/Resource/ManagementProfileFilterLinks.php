...
use Google\Site_Kit_Dependencies\Google\Service\Analytics\ProfileFilterLink;
use Google\Site_Kit_Dependencies\Google\Service\Analytics\ProfileFilterLinks;
/**
...
class ManagementProfileFilterLinks extends \Google\Site_Kit_Dependencies\Google\Service\Resource
{
    ...
    public function get($accountId, $webPropertyId, $profileId, $linkId, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'linkId' => $linkId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\ProfileFilterLink::class);
    }
    /**
    ...
    public function insert($accountId, $webPropertyId, $profileId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\ProfileFilterLink $postBody, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\ProfileFilterLink::class);
    }
    /**
    ...
    public function listManagementProfileFilterLinks($accountId, $webPropertyId, $profileId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\ProfileFilterLinks::class);
    }
    /**
    ...
    public function patch($accountId, $webPropertyId, $profileId, $linkId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\ProfileFilterLink $postBody, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\ProfileFilterLink::class);
    }
    /**
    ...
    public function update($accountId, $webPropertyId, $profileId, $linkId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\ProfileFilterLink $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'linkId' => $linkId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\ProfileFilterLink::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\Analytics\Resource\ManagementProfileFilterLinks::class, 'Google\\Site_Kit_Dependencies\\Google_Service_Analytics_Resource_ManagementProfileFilterLinks');
