 ...
 *  </code>
 */
class ManagementWebpropertyUserLinks extends \Google\Site_Kit_Dependencies\Google\Service\Resource
{
    /**
     ...
     * @throws \Google\Service\Exception
     */
    public function insert($accountId, $webPropertyId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\EntityUserLink $postBody, $optParams = [])
    {
     ...
     * @throws \Google\Service\Exception
     */
    public function update($accountId, $webPropertyId, $linkId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\EntityUserLink $postBody, $optParams = [])
    {
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\Analytics\Resource\ManagementWebpropertyUserLinks::class, 'Google\\Site_Kit_Dependencies\\Google_Service_Analytics_Resource_ManagementWebpropertyUserLinks');
