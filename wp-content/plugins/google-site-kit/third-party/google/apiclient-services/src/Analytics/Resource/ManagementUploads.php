...
use Google\Site_Kit_Dependencies\Google\Service\Analytics\AnalyticsDataimportDeleteUploadDataRequest;
use Google\Site_Kit_Dependencies\Google\Service\Analytics\Upload;
use Google\Site_Kit_Dependencies\Google\Service\Analytics\Uploads;
/**
 ...
 *  </code>
 */
class ManagementUploads extends \Google\Site_Kit_Dependencies\Google\Service\Resource
{
    /**
     ...
     */
    public function deleteUploadData($accountId, $webPropertyId, $customDataSourceId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\AnalyticsDataimportDeleteUploadDataRequest $postBody, $optParams = [])
    {
    ...
    public function get($accountId, $webPropertyId, $customDataSourceId, $uploadId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Upload::class);
    }
    /**
    ...
    public function listManagementUploads($accountId, $webPropertyId, $customDataSourceId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Uploads::class);
    }
    /**
    ...
    public function uploadData($accountId, $webPropertyId, $customDataSourceId, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customDataSourceId' => $customDataSourceId];
        $params = \array_merge($params, $optParams);
        return $this->call('uploadData', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Upload::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\Analytics\Resource\ManagementUploads::class, 'Google\\Site_Kit_Dependencies\\Google_Service_Analytics_Resource_ManagementUploads');
