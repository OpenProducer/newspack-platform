...
use Google\Site_Kit_Dependencies\Google\Service\Analytics\UnsampledReport;
use Google\Site_Kit_Dependencies\Google\Service\Analytics\UnsampledReports;
/**
 ...
 *  </code>
 */
class ManagementUnsampledReports extends \Google\Site_Kit_Dependencies\Google\Service\Resource
{
    /**
    ...
    public function get($accountId, $webPropertyId, $profileId, $unsampledReportId, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'unsampledReportId' => $unsampledReportId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\UnsampledReport::class);
    }
    /**
     ...
     * @throws \Google\Service\Exception
     */
    public function insert($accountId, $webPropertyId, $profileId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\UnsampledReport $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\UnsampledReport::class);
    }
    /**
    ...
    public function listManagementUnsampledReports($accountId, $webPropertyId, $profileId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\UnsampledReports::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\Analytics\Resource\ManagementUnsampledReports::class, 'Google\\Site_Kit_Dependencies\\Google_Service_Analytics_Resource_ManagementUnsampledReports');
