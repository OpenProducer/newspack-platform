...
use Google\Site_Kit_Dependencies\Google\Service\Analytics\Experiment;
use Google\Site_Kit_Dependencies\Google\Service\Analytics\Experiments;
/**
...
class ManagementExperiments extends \Google\Site_Kit_Dependencies\Google\Service\Resource
{
    ...
    public function get($accountId, $webPropertyId, $profileId, $experimentId, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'experimentId' => $experimentId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Experiment::class);
    }
    /**
    ...
    public function insert($accountId, $webPropertyId, $profileId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\Experiment $postBody, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Experiment::class);
    }
    /**
    ...
    public function listManagementExperiments($accountId, $webPropertyId, $profileId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Experiments::class);
    }
    /**
    ...
    public function patch($accountId, $webPropertyId, $profileId, $experimentId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\Experiment $postBody, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Experiment::class);
    }
    /**
    ...
    public function update($accountId, $webPropertyId, $profileId, $experimentId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\Experiment $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'experimentId' => $experimentId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Experiment::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\Analytics\Resource\ManagementExperiments::class, 'Google\\Site_Kit_Dependencies\\Google_Service_Analytics_Resource_ManagementExperiments');
