...
use Google\Site_Kit_Dependencies\Google\Service\Analytics\RemarketingAudience;
use Google\Site_Kit_Dependencies\Google\Service\Analytics\RemarketingAudiences;
/**
 ...
 *  </code>
 */
class ManagementRemarketingAudience extends \Google\Site_Kit_Dependencies\Google\Service\Resource
{
    /**
    ...
    public function get($accountId, $webPropertyId, $remarketingAudienceId, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'remarketingAudienceId' => $remarketingAudienceId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\RemarketingAudience::class);
    }
    /**
     ...
     * @throws \Google\Service\Exception
     */
    public function insert($accountId, $webPropertyId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\RemarketingAudience $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\RemarketingAudience::class);
    }
    /**
    ...
    public function listManagementRemarketingAudience($accountId, $webPropertyId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\RemarketingAudiences::class);
    }
    /**
     ...
     * @throws \Google\Service\Exception
     */
    public function patch($accountId, $webPropertyId, $remarketingAudienceId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\RemarketingAudience $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'remarketingAudienceId' => $remarketingAudienceId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('patch', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\RemarketingAudience::class);
    }
    /**
     ...
     * @throws \Google\Service\Exception
     */
    public function update($accountId, $webPropertyId, $remarketingAudienceId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\RemarketingAudience $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'remarketingAudienceId' => $remarketingAudienceId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\RemarketingAudience::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\Analytics\Resource\ManagementRemarketingAudience::class, 'Google\\Site_Kit_Dependencies\\Google_Service_Analytics_Resource_ManagementRemarketingAudience');
