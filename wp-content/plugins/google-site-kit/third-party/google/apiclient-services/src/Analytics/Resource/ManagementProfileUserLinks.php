...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\Analytics\Resource\ManagementProfileUserLinks::class, 'Google\\Site_Kit_Dependencies\\Google_Service_Analytics_Resource_ManagementProfileUserLinks');
