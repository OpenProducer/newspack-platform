...
class ManagementWebproperties extends \Google\Site_Kit_Dependencies\Google\Service\Resource
{
    ...
    public function get($accountId, $webPropertyId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Webproperty::class);
    }
    /**
    ...
    public function insert($accountId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\Webproperty $postBody, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Webproperty::class);
    }
    /**
    ...
    public function listManagementWebproperties($accountId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Webproperties::class);
    }
    /**
    ...
    public function patch($accountId, $webPropertyId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\Webproperty $postBody, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Webproperty::class);
    }
    /**
    ...
    public function update($accountId, $webPropertyId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\Webproperty $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Webproperty::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\Analytics\Resource\ManagementWebproperties::class, 'Google\\Site_Kit_Dependencies\\Google_Service_Analytics_Resource_ManagementWebproperties');
