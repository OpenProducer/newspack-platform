...
class UserDeletionRequest extends \Google\Site_Kit_Dependencies\Google\Model
{
     ...
     */
    public function setId(\Google\Site_Kit_Dependencies\Google\Service\Analytics\UserDeletionRequestId $id)
    {
        $this->id = $id;
    }
    /**
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\Analytics\UserDeletionRequest::class, 'Google\\Site_Kit_Dependencies\\Google_Service_Analytics_UserDeletionRequest');
