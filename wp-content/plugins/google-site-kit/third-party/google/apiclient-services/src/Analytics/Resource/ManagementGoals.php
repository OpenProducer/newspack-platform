...
use Google\Site_Kit_Dependencies\Google\Service\Analytics\Goal;
use Google\Site_Kit_Dependencies\Google\Service\Analytics\Goals;
/**
...
class ManagementGoals extends \Google\Site_Kit_Dependencies\Google\Service\Resource
{
    ...
    public function get($accountId, $webPropertyId, $profileId, $goalId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Goal::class);
    }
    /**
    ...
    public function insert($accountId, $webPropertyId, $profileId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\Goal $postBody, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Goal::class);
    }
    /**
    ...
    public function listManagementGoals($accountId, $webPropertyId, $profileId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Goals::class);
    }
    /**
    ...
    public function patch($accountId, $webPropertyId, $profileId, $goalId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\Goal $postBody, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Goal::class);
    }
    /**
    ...
    public function update($accountId, $webPropertyId, $profileId, $goalId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\Goal $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'goalId' => $goalId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Goal::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\Analytics\Resource\ManagementGoals::class, 'Google\\Site_Kit_Dependencies\\Google_Service_Analytics_Resource_ManagementGoals');
