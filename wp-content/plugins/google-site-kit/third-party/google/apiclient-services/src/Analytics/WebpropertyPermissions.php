...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\Analytics\WebpropertyPermissions::class, 'Google\\Site_Kit_Dependencies\\Google_Service_Analytics_WebpropertyPermissions');
