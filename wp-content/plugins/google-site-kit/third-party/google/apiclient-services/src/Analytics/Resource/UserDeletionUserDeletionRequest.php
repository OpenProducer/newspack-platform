...
use Google\Site_Kit_Dependencies\Google\Service\Analytics\UserDeletionRequest;
/**
...
class UserDeletionUserDeletionRequest extends \Google\Site_Kit_Dependencies\Google\Service\Resource
{
    ...
    public function upsert(\Google\Site_Kit_Dependencies\Google\Service\Analytics\UserDeletionRequest $postBody, $optParams = [])
    {
        ...
        return $this->call('upsert', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\UserDeletionRequest::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\Analytics\Resource\UserDeletionUserDeletionRequest::class, 'Google\\Site_Kit_Dependencies\\Google_Service_Analytics_Resource_UserDeletionUserDeletionRequest');
