...
use Google\Site_Kit_Dependencies\Google\Service\Analytics\Filter;
use Google\Site_Kit_Dependencies\Google\Service\Analytics\Filters;
/**
...
class ManagementFilters extends \Google\Site_Kit_Dependencies\Google\Service\Resource
{
    ...
    public function delete($accountId, $filterId, $optParams = [])
    {
        ...
        return $this->call('delete', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Filter::class);
    }
    /**
    ...
    public function get($accountId, $filterId, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'filterId' => $filterId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Filter::class);
    }
    /**
    ...
    public function insert($accountId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\Filter $postBody, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Filter::class);
    }
    /**
    ...
    public function listManagementFilters($accountId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Filters::class);
    }
    /**
    ...
    public function patch($accountId, $filterId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\Filter $postBody, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Filter::class);
    }
    /**
    ...
    public function update($accountId, $filterId, \Google\Site_Kit_Dependencies\Google\Service\Analytics\Filter $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'filterId' => $filterId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \Google\Site_Kit_Dependencies\Google\Service\Analytics\Filter::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\Analytics\Resource\ManagementFilters::class, 'Google\\Site_Kit_Dependencies\\Google_Service_Analytics_Resource_ManagementFilters');
