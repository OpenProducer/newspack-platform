 ...
 * @author Google, Inc.
 */
class SearchConsole extends \Google\Site_Kit_Dependencies\Google\Service
{
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\SearchConsole::class, 'Google\\Site_Kit_Dependencies\\Google_Service_SearchConsole');
