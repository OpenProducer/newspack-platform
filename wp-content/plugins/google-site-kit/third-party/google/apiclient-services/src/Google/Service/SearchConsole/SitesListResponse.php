 ...
 * the License.
 */
class Google_Service_SearchConsole_SitesListResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'siteEntry';
    protected $siteEntryType = 'Google\Site_Kit_Dependencies\Google_Service_SearchConsole_WmxSite';
