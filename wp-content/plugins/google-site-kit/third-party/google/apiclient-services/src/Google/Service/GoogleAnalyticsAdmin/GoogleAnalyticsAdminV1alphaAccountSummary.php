 ...
 * the License.
 */
class Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaAccountSummary extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'propertySummaries';
    public $account;
    public $displayName;
    public $name;
    protected $propertySummariesType = 'Google\Site_Kit_Dependencies\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaPropertySummary';
