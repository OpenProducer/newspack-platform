 ...
 *  </code>
 */
class Google_Service_TagManager_Resource_AccountsContainersVersionHeaders extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function latest($parent, $optParams = array())
    {
        ...
        return $this->call('latest', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_ContainerVersionHeader");
    }
    /**
    ...
    public function listAccountsContainersVersionHeaders($parent, $optParams = array())
    {
        $params = array('parent' => $parent);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_ListContainerVersionsResponse");
    }
}
