 ...
 * @author Google, Inc.
 */
class Google_Service_SearchConsole extends \Google\Site_Kit_Dependencies\Google_Service
{
    ...
    public function __construct(\Google\Site_Kit_Dependencies\Google_Client $client, $rootUrl = null)
    {
        ...
        $this->searchanalytics = new \Google\Site_Kit_Dependencies\Google_Service_SearchConsole_Resource_Searchanalytics($this, $this->serviceName, 'searchanalytics', array('methods' => array('query' => array('path' => 'webmasters/v3/sites/{siteUrl}/searchAnalytics/query', 'httpMethod' => 'POST', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->sitemaps = new \Google\Site_Kit_Dependencies\Google_Service_SearchConsole_Resource_Sitemaps($this, $this->serviceName, 'sitemaps', array('methods' => array('delete' => array('path' => 'webmasters/v3/sites/{siteUrl}/sitemaps/{feedpath}', 'httpMethod' => 'DELETE', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'feedpath' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'webmasters/v3/sites/{siteUrl}/sitemaps/{feedpath}', 'httpMethod' => 'GET', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'feedpath' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'webmasters/v3/sites/{siteUrl}/sitemaps', 'httpMethod' => 'GET', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'sitemapIndex' => array('location' => 'query', 'type' => 'string'))), 'submit' => array('path' => 'webmasters/v3/sites/{siteUrl}/sitemaps/{feedpath}', 'httpMethod' => 'PUT', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'feedpath' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->sites = new \Google\Site_Kit_Dependencies\Google_Service_SearchConsole_Resource_Sites($this, $this->serviceName, 'sites', array('methods' => array('add' => array('path' => 'webmasters/v3/sites/{siteUrl}', 'httpMethod' => 'PUT', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'webmasters/v3/sites/{siteUrl}', 'httpMethod' => 'DELETE', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'webmasters/v3/sites/{siteUrl}', 'httpMethod' => 'GET', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'webmasters/v3/sites', 'httpMethod' => 'GET', 'parameters' => array()))));
        $this->urlTestingTools_mobileFriendlyTest = new \Google\Site_Kit_Dependencies\Google_Service_SearchConsole_Resource_UrlTestingToolsMobileFriendlyTest($this, $this->serviceName, 'mobileFriendlyTest', array('methods' => array('run' => array('path' => 'v1/urlTestingTools/mobileFriendlyTest:run', 'httpMethod' => 'POST', 'parameters' => array()))));
    }
}
