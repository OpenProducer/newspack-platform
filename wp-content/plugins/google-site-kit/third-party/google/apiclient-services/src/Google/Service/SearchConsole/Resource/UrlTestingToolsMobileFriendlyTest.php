 ...
 *  </code>
 */
class Google_Service_SearchConsole_Resource_UrlTestingToolsMobileFriendlyTest extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
     ...
     */
    public function run(\Google\Site_Kit_Dependencies\Google_Service_SearchConsole_RunMobileFriendlyTestRequest $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('run', array($params), "Google\Site_Kit_Dependencies\Google_Service_SearchConsole_RunMobileFriendlyTestResponse");
    }
}
