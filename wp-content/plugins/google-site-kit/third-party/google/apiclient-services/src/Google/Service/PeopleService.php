...
class Google_Service_PeopleService extends \Google\Site_Kit_Dependencies\Google_Service
{
    ...
    public function __construct(\Google\Site_Kit_Dependencies\Google_Client $client, $rootUrl = null)
    {
        ...
        $this->people_connections = new \Google\Site_Kit_Dependencies\Google_Service_PeopleService_Resource_PeopleConnections($this, $this->serviceName, 'connections', array('methods' => array('list' => array('path' => 'v1/{+resourceName}/connections', 'httpMethod' => 'GET', 'parameters' => array('resourceName' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'requestSyncToken' => array('location' => 'query', 'type' => 'boolean'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'pageSize' => array('location' => 'query', 'type' => 'integer'), 'requestMask.includeField' => array('location' => 'query', 'type' => 'string'), 'syncToken' => array('location' => 'query', 'type' => 'string'), 'personFields' => array('location' => 'query', 'type' => 'string'), 'sortOrder' => array('location' => 'query', 'type' => 'string'))))));
    }
}
