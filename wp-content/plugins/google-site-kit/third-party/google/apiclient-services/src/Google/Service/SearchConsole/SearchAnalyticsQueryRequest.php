 ...
 * the License.
 */
class Google_Service_SearchConsole_SearchAnalyticsQueryRequest extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'dimensions';
    public $aggregationType;
    public $dataState;
    protected $dimensionFilterGroupsType = 'Google\Site_Kit_Dependencies\Google_Service_SearchConsole_ApiDimensionFilterGroup';
