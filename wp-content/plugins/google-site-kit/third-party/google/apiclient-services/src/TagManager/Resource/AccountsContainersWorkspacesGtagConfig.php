...
use Google\Site_Kit_Dependencies\Google\Service\TagManager\GtagConfig;
use Google\Site_Kit_Dependencies\Google\Service\TagManager\ListGtagConfigResponse;
/**
