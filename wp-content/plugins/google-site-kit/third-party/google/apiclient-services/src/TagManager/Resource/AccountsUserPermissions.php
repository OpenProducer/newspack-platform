...
use Google\Site_Kit_Dependencies\Google\Service\TagManager\ListUserPermissionsResponse;
use Google\Site_Kit_Dependencies\Google\Service\TagManager\UserPermission;
/**
