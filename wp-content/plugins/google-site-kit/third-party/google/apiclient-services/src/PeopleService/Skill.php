...
class Skill extends \Google\Site_Kit_Dependencies\Google\Model
{
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\PeopleService\Skill::class, 'Google\\Site_Kit_Dependencies\\Google_Service_PeopleService_Skill');
