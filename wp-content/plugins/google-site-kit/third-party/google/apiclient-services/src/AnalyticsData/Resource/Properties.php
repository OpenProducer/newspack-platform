 ...
 * the License.
 */
namespace Google\Site_Kit_Dependencies\Google\Service\AnalyticsData\Resource;

use Google\Site_Kit_Dependencies\Google\Service\AnalyticsData\BatchRunPivotReportsRequest;
use Google\Site_Kit_Dependencies\Google\Service\AnalyticsData\BatchRunPivotReportsResponse;
use Google\Site_Kit_Dependencies\Google\Service\AnalyticsData\BatchRunReportsRequest;
use Google\Site_Kit_Dependencies\Google\Service\AnalyticsData\BatchRunReportsResponse;
use Google\Site_Kit_Dependencies\Google\Service\AnalyticsData\CheckCompatibilityRequest;
use Google\Site_Kit_Dependencies\Google\Service\AnalyticsData\CheckCompatibilityResponse;
use Google\Site_Kit_Dependencies\Google\Service\AnalyticsData\Metadata;
use Google\Site_Kit_Dependencies\Google\Service\AnalyticsData\RunPivotReportRequest;
use Google\Site_Kit_Dependencies\Google\Service\AnalyticsData\RunPivotReportResponse;
use Google\Site_Kit_Dependencies\Google\Service\AnalyticsData\RunRealtimeReportRequest;
use Google\Site_Kit_Dependencies\Google\Service\AnalyticsData\RunRealtimeReportResponse;
