...
class GoogleAnalyticsAdminV1alphaListSubpropertySyncConfigsResponse extends \Google\Site_Kit_Dependencies\Google\Collection
{
     ...
     *
     * @param GoogleAnalyticsAdminV1alphaSubpropertySyncConfig[] $subpropertySyncConfigs
     */
