...
class GoogleAnalyticsAdminV1alphaListRollupPropertySourceLinksResponse extends \Google\Site_Kit_Dependencies\Google\Collection
{
     ...
     *
     * @param GoogleAnalyticsAdminV1alphaRollupPropertySourceLink[] $rollupPropertySourceLinks
     */
