...
class GoogleAnalyticsAdminV1alphaSubpropertyEventFilterConditionStringFilter extends \Google\Site_Kit_Dependencies\Google\Model
{
    /**
    ...
    /**
     * Optional. If true, the string value is case sensitive. If false, the match
     * is case-insensitive.
     *
     * @var bool
     */
