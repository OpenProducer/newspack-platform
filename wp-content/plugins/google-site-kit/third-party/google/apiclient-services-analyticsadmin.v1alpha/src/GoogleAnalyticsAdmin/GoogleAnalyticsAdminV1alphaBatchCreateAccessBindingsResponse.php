...
class GoogleAnalyticsAdminV1alphaBatchCreateAccessBindingsResponse extends \Google\Site_Kit_Dependencies\Google\Collection
{
     ...
     *
     * @param GoogleAnalyticsAdminV1alphaAccessBinding[] $accessBindings
     */
...
\class_alias(\Google\Site_Kit_Dependencies\Google\Service\GoogleAnalyticsAdminV1alpha\GoogleAnalyticsAdminV1alphaBatchCreateAccessBindingsResponse::class, 'Google\\Site_Kit_Dependencies\\Google_Service_GoogleAnalyticsAdminV1alpha_GoogleAnalyticsAdminV1alphaBatchCreateAccessBindingsResponse');
