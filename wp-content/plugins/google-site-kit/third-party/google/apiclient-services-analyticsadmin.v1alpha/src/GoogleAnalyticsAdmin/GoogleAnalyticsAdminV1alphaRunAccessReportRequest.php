...
class GoogleAnalyticsAdminV1alphaRunAccessReportRequest extends \Google\Site_Kit_Dependencies\Google\Collection
{
     ...
     * to 2 date ranges.
     *
     * @param GoogleAnalyticsAdminV1alphaAccessDateRange[] $dateRanges
     */
     ...
     *
     * @param GoogleAnalyticsAdminV1alphaAccessDimension[] $dimensions
     */
     ...
     * up to 10 metrics.
     *
     * @param GoogleAnalyticsAdminV1alphaAccessMetric[] $metrics
     */
     ...
     *
     * @param GoogleAnalyticsAdminV1alphaAccessOrderBy[] $orderBys
     */
