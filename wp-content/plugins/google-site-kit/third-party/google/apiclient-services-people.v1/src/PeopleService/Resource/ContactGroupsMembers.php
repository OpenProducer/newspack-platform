...
use Google\Site_Kit_Dependencies\Google\Service\PeopleService\ModifyContactGroupMembersRequest;
use Google\Site_Kit_Dependencies\Google\Service\PeopleService\ModifyContactGroupMembersResponse;
/**
