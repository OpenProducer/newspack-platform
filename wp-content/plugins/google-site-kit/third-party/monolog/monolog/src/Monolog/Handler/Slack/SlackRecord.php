...
class SlackRecord
{
     ...
     */
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), ?\Google\Site_Kit_Dependencies\Monolog\Formatter\FormatterInterface $formatter = null)
    {
    ...
    public function setFormatter(?\Google\Site_Kit_Dependencies\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {
