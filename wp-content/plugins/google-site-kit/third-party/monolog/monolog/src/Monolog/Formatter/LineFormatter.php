...
class LineFormatter extends \Google\Site_Kit_Dependencies\Monolog\Formatter\NormalizerFormatter
{
    ...
    public function format(array $record) : string
    {
        ...
        if (\false !== \strpos($output, '%')) {
            ...
            if (null === $output) {
                ...
                throw new \RuntimeException('Failed to run preg_replace: ' . $pcreErrorCode . ' / ' . \Google\Site_Kit_Dependencies\Monolog\Utils::pcreLastErrorMessage($pcreErrorCode));
            }
        }
        return $output;
    }
    ...
    {
        $str = '[object] (' . \Google\Site_Kit_Dependencies\Monolog\Utils::getClass($e) . '(code: ' . $e->getCode();
